...
// Convert Map to byte array
    ...
    public static Map<String, Object> genSignature(Map<String, Object> map) {
      //  System.out.println(">>>>>>>> Start Add Signature  ");
        try {
            ...
            map.put("signature",SignDoc(Profile.privateKey,arrayList));
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static Map<String, Object> VerifySignature(Map<String, Object> map){
        ...
        try {
            ...
            boolean verifySignature= VerifySignature(Profile.mapPublicKey.get(Profile.uniqueIDServer), (String) map.get("signature"),arrayList);
